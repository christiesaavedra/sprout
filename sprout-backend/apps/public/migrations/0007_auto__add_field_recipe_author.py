...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'public_recipe', 'author',
                      self.gf('django.db.models.fields.CharField')(default='Please add an author', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.author'
        db.delete_column(u'public_recipe', 'author')
