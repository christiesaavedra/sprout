...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field favorited_by on 'Recipe'
        m2m_table_name = db.shorten_name(u'public_recipe_favorited_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipe', models.ForeignKey(orm[u'public.recipe'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['recipe_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field favorited_by on 'Recipe'
        db.delete_table(db.shorten_name(u'public_recipe_favorited_by'))
    ...
    models = {
        ...
        u'public.recipe': {
            ...
            'favorited_by': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
